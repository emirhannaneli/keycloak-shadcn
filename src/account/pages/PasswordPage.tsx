...
export default function PasswordPage({
    ...
    const { url, messagesPerField, message, password, account } = kcContext;

    return (
        <KcCard
                kcContext={kcContext}
                title={i18nToString(i18n, "passwordTitleHtml") || i18nToString(i18n, "passwordTitle") || "Password"}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <KcInput
                                ...
                                aria-invalid={messagesPerField.existsError("password-new", "password-confirm")}
                                aria-describedby={
                                    messagesPerField.existsError("password-new", "password-confirm")
                                        ? "password-new-error"
                                        : undefined
                                }
                                className={
