...
const messages = {
    ...
    federatedIdentityTitle: "الحسابات المتصلة",
    federatedIdentityTitleHtml: "الحسابات المتصلة",
    activeSessions: "Active Sessions",
    active: "active",
    applications: "التطبيقات",
    authorizedApps: "authorized applications",
    federatedIdentity: "الحسابات المتصلة",
    ...
    noFederatedIdentity: "لا توجد حسابات متصلة",
    date: "التاريخ",
    details: "التفاصيل",
