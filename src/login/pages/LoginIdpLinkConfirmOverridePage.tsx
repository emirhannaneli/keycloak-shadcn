...
export default function LoginIdpLinkConfirmOverridePage({
    kcContext,
}: {
    ...
    const { url, message, idpDisplayName, realm } = kcContext;
        ...
        <div className="flex min-h-screen items-center justify-center p-4">
            ...
            >
                ...
                <div className="text-center mb-6">
                    ...
                    {idpDisplayName && (
                        <p className="font-medium text-foreground">{idpDisplayName}</p>
                    )}
                </div>
                ...
                <KcForm
                    ...
                    method="post"
                    id="kc-idp-link-confirm-override-form"
                >
